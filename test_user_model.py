...
class UserModelTestCase(TestCase):
    ...
    def test_valid_signup(self):
        u_test = User.signup("anakin", "darthvader@test.com", "password", None)
        uid = 66
        u_test.id = uid
        db.session.commit()
        ...
        self.assertEqual(u_test.username, "anakin")
        self.assertEqual(u_test.email, "darthvader@test.com")
        self.assertNotEqual(u_test.password, "password")
        # Bcrypt strings should start with $2b$
        self.assertTrue(u_test.password.startswith("$2b$"))

    def test_invalid_username_signup(self):
        not_valid = User.signup(None, "test@test.com", "password", None)
        uid = 123456789
        not_valid.id = uid
